...
func load_game() -> void:
	...
	# Security: Prevent crash from tampered save file by validating type before assignment
	if typeof(json.data) != TYPE_DICTIONARY:
		push_error("ProgressManager: Save file data is not a valid dictionary.")
		return
